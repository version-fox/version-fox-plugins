...
AvailableVersionsUrl = "https://marketplace-api.adoptium.net/v1/info/available_releases/microsoft"
DownloadLatestUrl = "https://marketplace-api.adoptium.net/v1/assets/latest/microsoft/%s/hotspot"

PLUGIN = {
    name = "java",
    author = "axdank",
    version = "0.0.1",
    description = "Microsoft JDK - Adoptium",
    updateUrl = "https://raw.githubusercontent.com/version-fox/version-fox-plugins/main/java/microsoft-adoptium-jdk.lua",
}
