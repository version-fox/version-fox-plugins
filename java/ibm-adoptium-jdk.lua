...
AvailableVersionsUrl = "https://marketplace-api.adoptium.net/v1/info/available_releases/ibm"
DownloadLatestUrl = "https://marketplace-api.adoptium.net/v1/assets/latest/ibm/%s/openj9"
