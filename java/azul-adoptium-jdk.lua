...
AvailableVersionsUrl = "https://marketplace-api.adoptium.net/v1/info/available_releases/azul"
DownloadLatestUrl = "https://marketplace-api.adoptium.net/v1/assets/latest/azul/%s/hotspot"
...
function PLUGIN:PreInstall(ctx)
    ...
    if binaryInfo == nil then
      ...
      return {
          ...
          sha256 = binaryInfo.binary.package.sha265sum,
      }
    end
