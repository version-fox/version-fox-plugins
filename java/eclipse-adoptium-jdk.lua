...
AvailableVersionsUrl = "https://marketplace-api.adoptium.net/v1/info/available_releases/adoptium"
DownloadLatestUrl = "https://marketplace-api.adoptium.net/v1/assets/latest/adoptium/%s/hotspot"

PLUGIN = {
    name = "java",
    author = "axdank",
    version = "0.0.1",
    description = "Eclipse (Temurin) JDK - Adoptium",
    updateUrl = "https://raw.githubusercontent.com/version-fox/version-fox-plugins/main/java/eclipse-adoptium-jdk.lua",
}
