---    Copyright 2024 [b3nguang benguang04@gmail.com]
--
...
local PYTHON_URL = "https://mirrors.huaweicloud.com/python/"

local DOWNLOAD_SOURCE = {
    --- TODO support zip or web-based installers
    WEB_BASED = "https://mirrors.huaweicloud.com/python/%s/python-%s%s-webinstall.exe",
    ZIP = "https://mirrors.huaweicloud.com/python/%s/python-%s-embed-%s.zip",
    MSI = "",
    --- Currently only exe installers are supported
    EXE = "https://mirrors.huaweicloud.com/python/%s/python-%s%s.exe",
    SOURCE = "https://mirrors.huaweicloud.com/python/%s/Python-%s.tar.xz"
}
...
PLUGIN = {
    ...
    -- Update URL
    updateUrl = "https://raw.githubusercontent.com/version-fox/version-fox-plugins/main/python/python.lua",
